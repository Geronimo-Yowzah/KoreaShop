            ...
            <div class="content">
                ...
                <div>
                    <form action="edit.php" method="POST">
                        ...
                        ที่อยู่: <br> <textarea name="Address" cols="30" rows="3"><?=$row["Address"]?></textarea><br><br>
                        อีเมล: <input type="email" name="Email" value="<?=$row["Email"]?>"><br><br>
                        เบอร์โทรศัพท์: <input type="tel" name="Phone" value="<?=$row["Phone"]?>"><br><br>
